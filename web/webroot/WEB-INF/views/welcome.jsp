...
<html>
<head>
    <title>Welcome to myextension</title>
    <link rel="stylesheet" href="<c:url value="/static/myextension-webapp.css"/>" type="text/css"
...
<div class="container">
    ...
    <div>
        ...
        <ul>
            <li><b>resources/myextension-items.xml</b> - here you can model your items</li>
            <li><b>resources/myextension-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/myextension-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/myextension-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/myextension-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
